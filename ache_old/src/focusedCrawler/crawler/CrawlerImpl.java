...
//				System.out.println(source);
				PaginaURL pageParser = new PaginaURL(getUrl(), 0, 0,source.length(),source, null);
//				page = new Page(getUrl(),cleanContent(source));
...
//				page.setRelevance(relevance);
        ...
        private String cleanContent(String page) throws IOException{
			Html2Txt html2txt = new Html2Txt();
	        StringBuffer tempBuffer = new StringBuffer();
	        String[] sentences = html2txt.convert(page);
